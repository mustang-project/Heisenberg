; IDL FUNCTIONS FOR APPLYING THE UNCERTAINY PRINCIPLE OF 
...
;       IDL> lambda=130.
;       IDL> beta_2=0.5
;       IDL> ratiobias_1=f_ratiobias_1(t_1,t_2,t_over,l_ap,lambda,beta_2) 
;       IDL> print,ratiobias_1
;              2.03549
;
; FILE STRUCTURE: 
...
function f_deltax,t_1,t_2,t_over,lambda,sfr_min,surfsfr,veldis ;size-scale below which galactic SF relations fail
...
function f_scatter,t_1,t_2,t_over,l_ap,lambda,beta_1,beta_2,sigma_1evo1,sigma_2evo1,sigma_mf1,sigma_obs ;scatter in log(tracer ratio)
    tau=t_1+t_2-t_over ;total duration of process
...
function f_ratiobias_1,t_1,t_2,t_over,l_ap,lambda,beta_2 ;bias of the tracer ratio (e.g. t_depl) when focussing apertures on phase 1 tracer peaks
...
function f_ratiobias_2,t_1,t_2,t_over,l_ap,lambda,beta_1 ;bias of the tracer ratio (e.g. t_depl) when focussing apertures on phase 2 tracer peaks
